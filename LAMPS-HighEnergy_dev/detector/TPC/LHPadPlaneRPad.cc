...
bool LHPadPlaneRPad::Init()
{
  ...
  fTanPi9o8 = TMath::Tan(TMath::Pi() * 9. / 8.);
  fTanPi11o8 = TMath::Tan(TMath::Pi() * 11. / 8.);
  fTanPi13o8 = TMath::Tan(TMath::Pi() * 13. / 8.);
  fTanPi15o8 = TMath::Tan(TMath::Pi() * 15. / 8.);
  ...
  fFuncXRightBound = new TF1("RightBound", Form("%f*(x-%f)+%f", fTanPi3o8, .5 * fWPPBot, fYPPMin), 0, 500);
  fFuncXRightBoundInverse = new TF1("RightBoundInverse", Form("(x-%f)/%f+%f", fYPPMin, fTanPi3o8, .5 * fWPPBot), 0, 500);
    ...
    for (Int_t layer = 0; true; ++layer)
    {
      ...
      for (Int_t row = 1; true; ++row)
      {
        ...
        for (auto pm : {1, -1}) // right-half and left-half
        {
          ...
          else if (yPadTop < fFuncXRightBound->Eval(xPadOut))
            cuttedTo3 = true;
          else if (yPadBot < fFuncXRightBound->Eval(xPadInn))
            cuttedTo4 = true;
          else if (yPadBot < fFuncXRightBound->Eval(xPadOut))
            cuttedTo5 = true;
...
Int_t LHPadPlaneRPad::FindPadID(Double_t i, Double_t j)
{
  ...
  Int_t section2 = FindSection(xRot,yRot);
  // kb_debug << section << "\t" << section2 << endl;
...
void LHPadPlaneRPad::DrawFrame(Option_t *)
{
  ...
  TLine *line1 = new TLine(fRMax * TMath::Cos(TMath::Pi() * 1 / 8), fRMax * TMath::Sin(TMath::Pi() * 1 / 8),
                           fRMin * TMath::Cos(TMath::Pi() * 1 / 8), fRMin * TMath::Sin(TMath::Pi() * 1 / 8));
  TLine *line2 = new TLine(fRMax * TMath::Cos(TMath::Pi() * 3 / 8), fRMax * TMath::Sin(TMath::Pi() * 3 / 8),
                           fRMin * TMath::Cos(TMath::Pi() * 3 / 8), fRMin * TMath::Sin(TMath::Pi() * 3 / 8));
  TLine *line3 = new TLine(fRMax * TMath::Cos(TMath::Pi() * 5 / 8), fRMax * TMath::Sin(TMath::Pi() * 5 / 8),
                           fRMin * TMath::Cos(TMath::Pi() * 5 / 8), fRMin * TMath::Sin(TMath::Pi() * 5 / 8));
  TLine *line4 = new TLine(fRMax * TMath::Cos(TMath::Pi() * 7 / 8), fRMax * TMath::Sin(TMath::Pi() * 7 / 8),
                           fRMin * TMath::Cos(TMath::Pi() * 7 / 8), fRMin * TMath::Sin(TMath::Pi() * 7 / 8));
  TLine *line5 = new TLine(fRMax * TMath::Cos(TMath::Pi() * 9 / 8), fRMax * TMath::Sin(TMath::Pi() * 9 / 8),
                           fRMin * TMath::Cos(TMath::Pi() * 9 / 8), fRMin * TMath::Sin(TMath::Pi() * 9 / 8));
  TLine *line6 = new TLine(fRMax * TMath::Cos(TMath::Pi() * 11 / 8), fRMax * TMath::Sin(TMath::Pi() * 11 / 8),
                           fRMin * TMath::Cos(TMath::Pi() * 11 / 8), fRMin * TMath::Sin(TMath::Pi() * 11 / 8));
  TLine *line7 = new TLine(fRMax * TMath::Cos(TMath::Pi() * 13 / 8), fRMax * TMath::Sin(TMath::Pi() * 13 / 8),
                           fRMin * TMath::Cos(TMath::Pi() * 13 / 8), fRMin * TMath::Sin(TMath::Pi() * 13 / 8));
  TLine *line8 = new TLine(fRMax * TMath::Cos(TMath::Pi() * 15 / 8), fRMax * TMath::Sin(TMath::Pi() * 15 / 8),
...
Int_t LHPadPlaneRPad::FindSection(Double_t i, Double_t j)
{
  ...
  */
  ...
  if (i > 0 && j > 0)
  {
    if (value > fTanPi15o8 && value < fTanPi1o8)
    {
      if(kdebug) kb_debug << 6 << endl;
      return 6;
    }
    if (value > fTanPi1o8 && value < fTanPi3o8)
    {
      if(kdebug) kb_debug << 7 << endl;
      return 7;
    }
    if (value > fTanPi3o8 && value < fTanPi5o8)
    {
      if(kdebug) kb_debug << 0 << endl;
      return 0;
    }
  }
  ...
  if (i < 0 && j > 0)
  {
    ...
    if (value > fTanPi5o8 && value < fTanPi7o8)
    {
      if(kdebug) kb_debug << 1 << endl;
      return 1;
    }
    if (value > fTanPi7o8 && value < fTanPi9o8)
    {
      if(kdebug) kb_debug << 2 << endl;
      return 2;
    }
  }
  ...
  if (i < 0 && j < 0)
  {
    ...
    if (value > fTanPi9o8 && value < fTanPi11o8)
    {
      if(kdebug) kb_debug << 3 << endl;
      return 3;
    }
    if (value > fTanPi11o8 && value < fTanPi13o8)
    {
      if(kdebug) kb_debug << 4 << endl;
      return 4;
    }
  }
  ...
  if (i > 0 && j < 0)
  {
    ...
    if (value > fTanPi13o8 && value < fTanPi15o8)
    {
      if(kdebug) kb_debug << 5 << endl;
      return 5;
    }
    if (value > fTanPi15o8 && value < fTanPi1o8)
    {
