...
ClassImp(LHClusterHitTask)

    bool LHClusterHitTask::Init()
{
...
#ifdef DEBUG_STEP
  if (fNextStep == kStepInitArray)
    kb_debug << "NextStep is StepInitArray" << endl;
  else if (fNextStep == kStepNewTrack)
    kb_debug << "NextStep is StepNewTrack" << endl;
  else if (fNextStep == kStepRemoveTrack)
    kb_debug << "NextStep is StepRemoveTrack" << endl;
  else if (fNextStep == kStepInitTrack)
    kb_debug << "NextStep is StepInitTrack" << endl;
  else if (fNextStep == kStepInitTrackAddHit)
    kb_debug << "NextStep is StepInitTrackAddHit" << endl;
  else if (fNextStep == kStepContinuum)
    kb_debug << "NextStep is StepContinuum" << endl;
  else if (fNextStep == kStepContinuumAddHit)
    kb_debug << "NextStep is StepContinuumAddHit" << endl;
  else if (fNextStep == kStepExtrapolation)
    kb_debug << "NextStep is StepExtrapolation" << endl;
  else if (fNextStep == kStepExtrapolationAddHit)
    kb_debug << "NextStep is StepExtrapolationAddHit" << endl;
  else if (fNextStep == kStepConfirmation)
    kb_debug << "NextStep is StepConfirmation" << endl;
  else if (fNextStep == kStepFinalizeTrack)
    kb_debug << "NextStep is StepFinalizeTrack" << endl;
  else if (fNextStep == kStepNextPhase)
    kb_debug << "NextStep is StepNextPhase" << endl;
  else if (fNextStep == kStepEndEvent)
    kb_debug << "NextStep is StepEndEvent" << endl;
